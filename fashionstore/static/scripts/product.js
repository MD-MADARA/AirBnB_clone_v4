function Simular_products(p_ctgName, p_ctgType, from, p_id) {
  fetch(`http://localhost:5001/api/products/${p_ctgType}/${p_ctgName}?from=${from}&ignore=${p_id}&limit=15&order_desc=id`)
  .then(response => {
    if (!response.ok) {
        ...
        function addItem() {
            if (amountValue > 0) {
              ...
              if (user_id) {
                ...
                fetch(`http://127.0.0.1:5001/api/users/${user_id}/cart/`, {
                  method: 'POST',
                  headers: {
                ...
                .then(data => {
                  ...
                  `<div>
                      ...
                      <button class="delete-btn" onclick="
                          fetch('http://127.0.0.1:5001/api/users/${user_id}/cart/${p_id}', {method: 'DELETE'})
                          .then(response => {
                              return response.json();
                          })
                          .then(data => {
