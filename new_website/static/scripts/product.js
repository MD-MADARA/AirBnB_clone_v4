function Simular_products(p_ctgName, p_ctgType, from, p_id) {
  fetch(`http://web-01.madaralx.tech/api/products/${p_ctgType}/${p_ctgName}?from=${from}&ignore=${p_id}&limit=15&order_desc=id`)
  .then(response => {
    if (!response.ok) {
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    fetch('http://web-01.madaralx.tech/api/products/' + product_id)
    .then(response => {
        if (!response.ok) {
          throw new Error('Network response was not ok');
        }
        ...
        function addItem() {
            if (amountValue > 0) {
              ...
              if (user_id) {
                ...
                fetch(`http://web-01.madaralx.tech/api/users/${user_id}/cart/`, {
                  method: 'POST',
                  headers: {
                ...
                .then(data => {
                  ...
                  `<div>
                      ...
                      <button class="delete-btn" onclick="
                          fetch('http://web-01.madaralx.tech/api/users/${user_id}/cart/${p_id}', {method: 'DELETE'})
                          .then(response => {
                              return response.json();
                          })
                          .then(data => {
